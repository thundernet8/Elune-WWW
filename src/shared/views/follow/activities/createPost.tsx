...
interface CreatePostActivityProps {
    activity: Userlog;
}

interface CreatePostActivityState {}

export default class CreatePostActivity extends React.Component<
    CreatePostActivityProps,
    CreatePostActivityState
> {
    constructor(props) {
        super(props);
    }
        ...
        return (
            <div className={styles.activityRow}>
                <div className={styles.icon}>
                    <span style={{ background: getCharColor("p") }}>
