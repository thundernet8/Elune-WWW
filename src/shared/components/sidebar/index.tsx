                ...
                <div className={ClassNames("widget", [styles.widget])}>
                    <div className="widget-content">
                        <a href="https://webapproach.net/go/do" target="_blank">
                            <img
                                src="https://api.elune.me/content/images/2017/10/19/a127058b1f84e24760e7da360978a746.png"
                                style={{ maxWidth: "100%" }}
                            />
                        </a>
                    </div>
                ...
                <div className="widget">
                    <div className="widget-content">
                        <a href="https://webapproach.net/go/cl" target="_blank">
                            <img
                                src="https://api.elune.me/content/images/2017/10/19/b1f7279c640a51c2d4bf5983a328ad64.jpg"
                                style={{ maxWidth: "100%" }}
                            />
                        </a>
                    </div>
